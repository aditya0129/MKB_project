...
import { faWhatsapp,faFacebookF,faLinkedinIn,faInstagram  } from "@fortawesome/free-brands-svg-icons";
    ...
    return(
        ...
        <div className="container mt-5 advisor">
            <div className="row">
                ...
                <img src="boy-img.jpg" alt="" style={{height:"200px",width:"200px",borderRadius:"150px"}}/>
                </div>
                <div className="col-md-4 mt-5">
                    <h1>Jeremy Rose</h1>
                    ...
                    <button className="" type="button" style={{background:"linear-gradient(135deg,cyan,blue)",border:"none",borderRadius:"7px",width:"70px",height:"40px",color:"white"}}><FontAwesomeIcon className="me-2" icon={faPhone} />Call</button>
                    <FontAwesomeIcon className="ms-4" icon={faPhone} /> Waiting Call
                    <p className="mt-3"><FontAwesomeIcon icon={faComment} /> No. of chats</p>
                    <p className="mt-3"><FontAwesomeIcon icon={faVideo} /> No. of video-calls</p>
                    <p className="mt-3"><FontAwesomeIcon icon={faMinus} /> review <FontAwesomeIcon className="ms-4" icon={faPlus} /> review</p>
                </div>
                <div className="col-md-4 mt-5">
